...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference("Practice.count") do
      post practices_url, params: { practice: { duration: @practice.duration, hours_per_student: @practice.hours_per_student, kind: @practice.kind } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { duration: @practice.duration, hours_per_student: @practice.hours_per_student, kind: @practice.kind } }
